function updateFigure(icfs_norm, x, hPlot, hPeaks, numPeaks, peakDistances, sliderValueText, index)
    ...
    % Update the figure
    set(hPlot, 'XData', x, 'YData', icfs_norm);
